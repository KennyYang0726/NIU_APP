...
這是一個給宜大學生使用的APP，整合了大部分常使用到的功能， 包含數位學習M園區、分數查詢、課表、活動報名、畢業門檻查詢、選課、請假 並提供公動態查詢和Zuvio。
...
<table>
  ...
  <tr>
    <td colspan="3">
      <img src="https://github.com/JamesYang0826/NIU_APP_Assets/releases/download/NIU_APP_Assets/01.gif" width="800">
    </td>
  </tr>
  <tr>
    <th> 
